...
public class ReportTest {
  ...
  /**
   * Tests that Farm Report is correctly constructed from some sample data
   */
  @Test
  public void test000_farm_report() {
    ...
    try {
      ...
      for (int i = 2; i <= 12; i++) {
        Pair<String, Integer> restOfMonths = new Pair<String, Integer>("Month " + String.valueOf(i), 0);
  ...
  /**
   * Tests that Annual Report is correctly constructed with sample data
   */
  @Test
  ...
  /**
   * Tests that the montly report is correctly constructed with sample data
   */
  @Test
  ...
  /**
   * Tests that a date range report is correctly constructed with sample data
   */
  @Test
  ...
  /**
   * Tests that an exception will be thrown if the user does not enter in a valid
   * farm ID when creating a farm report
   */
  @Test
  ...
  /**
   * Tests that an exception will be thrown if the user does not enter in a valid
   * year when creating a farm report
   */
  @Test
  ...
  /**
   * Tests that an exception will be thrown if the user does not enter in a valid
   * year when creating an annual report
   */
  @Test
  ...
  /**
   * Tests that an exception will be thrown if the user does not enter in a valid
   * start date for date range report
   */
  @Test
  ...
  /**
   * Tests that an exception will be thrown if the user does not enter in a valid
   * end date for date range report
   */
  @Test
